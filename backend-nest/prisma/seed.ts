...
async function main() {
  ...
  await prisma.user.createMany({
    data: [
      { id: randomUUID(), name: 'Nick Fury', phone: '9000000001', role: 'ADMIN', country: 'INDIA' },
      { id: randomUUID(), name: 'Captain Marvel', phone: '9000000002', role: 'MANAGER', country: 'INDIA' },
      { id: randomUUID(), name: 'Captain America', phone: '9000000003', role: 'MANAGER', country: 'AMERICA' },
      { id: randomUUID(), name: 'Thanos', phone: '9000000004', role: 'MEMBER', country: 'INDIA' },
      { id: randomUUID(), name: 'Thor', phone: '9000000005', role: 'MEMBER', country: 'INDIA' },
      { id: randomUUID(), name: 'Travis', phone: '9000000006', role: 'MEMBER', country: 'AMERICA' },
    ],
  })
